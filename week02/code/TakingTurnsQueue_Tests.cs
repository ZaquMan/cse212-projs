...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Players are being inserted to the beginning of the queue
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Players with "forever" turns are not being returned to the queue
    ...
    // Defect(s) Found: None, as the fix for the previous test (TestTakingTurnsQueue_ForeverZero) included negative turns

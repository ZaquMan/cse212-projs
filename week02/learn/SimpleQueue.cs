public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: The Dequeue function was removing the object at index 1 instead of 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The Enqueue function was placing each new value at index 0, ie cutting in line.
    ...
    private void Enqueue(int value) {
        ...
        var endIndex = _queue.Count();
        _queue.Insert(endIndex, value);
    }
